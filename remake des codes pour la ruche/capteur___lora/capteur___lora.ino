...
void loop() {
    ...
    //lora
    Serial.print("Envoie des informations: ");
    Serial.println("ok");
...
*//*
    LoRa.beginPacket();
    LoRa.println("envoie de la temperature");
    LoRa.endPacket();
    delay(5000);
    
    LoRa.beginPacket();
    LoRa.print(temp_hum_val[1]);
    LoRa.endPacket();
    delay(25000);
    
    LoRa.beginPacket();
    LoRa.println("envoie de l'humidité");
    LoRa.endPacket();
    delay(5000);
    
    LoRa.beginPacket();
    LoRa.println(temp_hum_val[0]);
    LoRa.endPacket();
    delay(25000);
    
    LoRa.beginPacket();
    LoRa.println("envoie du poids");
    LoRa.endPacket();
    delay(5000);
    */
    LoRa.beginPacket();
    LoRa.println(poids_final);
    LoRa.endPacket();
